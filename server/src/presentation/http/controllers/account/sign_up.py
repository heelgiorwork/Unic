...
from src.infrastructure.auth.exceptions import AlreadyAuthenticatedError
from src.infrastructure.auth.handlers.sign_up import (
    SignUpHandler,
    SignUpRequest,
    SignUpResponse,
)
...
from src.presentation.http.errors.callbacks import (
    log_error,
    log_info,
)
