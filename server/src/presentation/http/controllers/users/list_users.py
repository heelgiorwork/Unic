...
from src.services.common.ports.user_command_gateway import ListUsersQM
from src.services.common.query_params.sorting import SortingOrder
from src.services.queries.list_users import (
...
def create_list_users_router() -> APIRouter:
    ...
    async def list_users(
        ...
        response: ListUsersQM = await interactor.execute(request_data)
        return response
